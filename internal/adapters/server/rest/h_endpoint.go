...
// @Produce  json
// @Success  200  {object}  dopTypes.ListRep{results=[]entities.EndpointSt}
// @Failure  400  {object}  dopTypes.ErrRep
func (o *St) hEndpointList(c *gin.Context) {
	result, _, err := o.ucs.EndpointList(o.getRequestContext(c))
...
func (o *St) hEndpointGet(c *gin.Context) {
	...
	result, err := o.ucs.EndpointGet(o.getRequestContext(c), id)
	if dopHttps.Error(c, err) {
		return
	}
